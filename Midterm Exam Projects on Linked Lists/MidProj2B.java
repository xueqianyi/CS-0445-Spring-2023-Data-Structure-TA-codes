...
public class MidProj2B {
	...
	// Appending a character should be very fast (constant time) since the end of
	// the
	...
	// Due to the special case of deleting from the back of the list (going backward
	// in
	// the circular list) the deleteCharAt() method at the end of the list COULD be
	// very
	// very fast (constant time) if you checked for this special case. However, if
	// you
	// traversed forward to delete then this code will take a lot more time (linear
	// amount). Either is ok, since were you were not required to explicitly test
	// for
	// this special case.
	...
	// Inserting at the front should clearly be very fast (constant time) in a
	// linked list.
	...
	// Deleting at the front should also be very fast (constant time) in a linked
	// list.
	...
	// Inserting in the middle will require a traversal of the list and the time
	// will
